...
<html lang="pt-br" dir="ltr">
  <head>
    ...
    function validar(){
      ...
      var escola = formProf.escola.value;
      var turma = formProf.turma.value;
      var periodo = formProf.periodo.value;

      var esc = document.formProf.escola.options[document.formProf.escola.selectedIndex].text;
      var tur = document.formProf.turma.options[document.formProf.turma.selectedIndex].text;
      var peri = document.formProf.periodo.options[document.formProf.periodo.selectedIndex].text;

      if (escola == "") {
        xdialog.alert('Escola não selecionada!');
        formProf.escola.focus();
        return false;
      }
      if (turma == "") {
        xdialog.alert('Turma não selecionada!');
        formProf.turma.focus();
        return false;
      }
      ...
      <div class="row">
        <img src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Logo_TV_2015.png" alt="" width=60 height=40>
          <div class="col-sm-11 pl-5 ml-4 " align="center">
            ...
            <div class="container">
            <form action="../verificarDados/verificarProfessor.php" name="formProf" method="post" class="pl-5 pt-5 pb-5 text-left w-50">
            ...
            <div class="text-center pr-5">
              <input type="submit" value="Cadastrar" class="p-2 mt-1 btn-danger" onclick="return validar()"></input>
            </div>
